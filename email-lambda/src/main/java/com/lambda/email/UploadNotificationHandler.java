...
//
//public class UploadNotificationHandler implements RequestHandler<SNSEvent, Map<String, Object>> {
//    private final SesClient sesClient;
//    private final ObjectMapper objectMapper;
//
//    public UploadNotificationHandler() {
...
//                            .subject(Content.builder().data("File Upload Successful").build())
//                            .body(Body.builder().text(Content.builder()
//                                            .data(String.format("File %s (ID: %s) uploaded successfully.", fileName, fileId))
//                                            .build())
//                                    .build())
//                            .build())
//                    .build());
